...
pOrigin <- ggplot(data=wineData, aes(x=fixed.acidity)) + 
  geom_histogram()

pBinned <- ggplot(data=wineData, aes(x=fixed.acidity)) + 
...
ggplot(data=wineData, aes(x=volatile.acidity)) + 
...
ggplot(data=wineData, aes(x=chlorides)) + 
...
ggplot(data=wineData, aes(x=free.sulfur.dioxide)) + 
  geom_histogram(binwidth = 1)
```

```{r echo=FALSE}
# histogram of bound sulfur dioxide
ggplot(data=wineData, aes(x=bound.sulfur.dioxide)) + 
  geom_histogram(binwidth = 1)
```

```{r echo=FALSE}
# histogram of sulphates
ggplot(data=wineData, aes(x=sulphates)) + 
  geom_histogram(binwidth = 0.01)
```
